...
constrained_site_bounds <- st_read("data/data_drone/L0/mission-footprint/niwo_017/2019-10-09/niwo_017_2019-10-09_constrained-site-bounds.geoJSON")
...
ortho <- raster::brick(file.path("data", "data_drone", "L1", site_name, flight_datetime, paste0(site_name, "_", flight_datetime, "_ortho.tif"))) / 32768
cropped_ortho <- raster::crop(x = ortho, y = constrained_site_bounds)

dsm <- raster::raster(file.path("data", "data_drone", "L1", site_name, flight_datetime, paste0(site_name, "_", flight_datetime, "_dsm.tif")))
...
dense_point_cloud_catalog <- lidR::catalog(folder = file.path("data", "data_drone", "L1", site_name, flight_datetime, paste0(site_name, "_", flight_datetime, "_dense-point-cloud.las")))
...
sparse_point_cloud_catalog <- lidR::catalog(folder =  file.path("data", "data_drone", "L1", site_name, flight_datetime, paste0(site_name, "_", flight_datetime, "_sparse-point-cloud.las")))
...
# dense point cloud
writeLAS(las = cropped_dense_point_cloud, file = file.path("data", "data_drone", "L1", site_name, flight_datetime, paste0(site_name, "_", flight_datetime, "_dense-point-cloud_cropped.las")))

# sparse point cloud
writeLAS(las = cropped_sparse_point_cloud, file = file.path("data", "data_drone", "L1", site_name, flight_datetime, paste0(site_name, "_", flight_datetime, "_sparse-point-cloud_cropped.las")))
