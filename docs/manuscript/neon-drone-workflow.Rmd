...
Critically, our work to increase access to the elusive broad-extent/fine-grain observational domain with a mental model and an open workflow is an important, but incomplete effort towards accessible macroecology.
Illustrating this point, the reduced cost of Landsat images brought more researchers into the user base from lower-resourced institutions and underrepresented parts of the world to do more topically diverse science [@nagaraj2020], but some barriers to access still exist [@miller2016; @miller2016a].
For instance, nearly 30% of Landsat 8 users reported challenges to processing data to a usable point, and most users are highly educated men with many years of experience using satellite imagery and/or GIS software [@miller2016].
The Landsat archive was undeniably made more accessible, to the collective benefit of science and society [@miller2016; @nagaraj2020], but even broader access is possible.
Similarly, greater accessibility of UAS and NEON will require their user communities to be self-reflective and proactive about identifying and eliminating barriers [@nagy2021].
