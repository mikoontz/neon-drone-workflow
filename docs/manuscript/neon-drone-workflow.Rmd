...
We've experienced software glitches and freezing mid-flight due to compute resource overload when using tablets that weren't up to the task, which can create a hazardous situation.
