...
Many free, open source software tools exist for working with SfM data products including QGIS for visualization and GUI-based geospatial manipulation, CloudCompare for visualization and GUI-based manipulation of point clouds, and a suite of R packages [@atkins2022].
