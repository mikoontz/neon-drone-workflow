...
The FAA website is usually the best source of the most up-to-date information about the rules that might govern UAS research flights.
...
Illustrating this point: the reduced cost of Landsat images brought more researchers into the user base from lower-resourced institutions and underrepresented parts of the world to do more topically diverse science [@nagaraj2020], but those users are still overwhelmingly men [@miller2016; @miller2016a].
Fuller accessibility of Landsat requires striving to reduce that demographic bias. 
Similarly, it is incumbent upon the UAS and NEON community to be self-reflective about who is being excluded from the community and to be proactive about what steps can be taken to make it more inclusive.
